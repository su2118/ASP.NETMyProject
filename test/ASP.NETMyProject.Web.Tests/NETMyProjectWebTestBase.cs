...
using ASP.NETMyProject.Models.TokenAuth;
...
{
    public abstract class NETMyProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static NETMyProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(NETMyProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<NETMyProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<NETMyProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<NETMyProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<NETMyProjectDbContext, Task<T>> func)
        {
            T result;
