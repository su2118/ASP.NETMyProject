...
using ASP.NETMyProject.Sessions;
using ASP.NETMyProject.Web.Models.Account;
using ASP.NETMyProject.Web.Views.Shared.Components.TenantChange;

namespace ASP.NETMyProject.Web.Controllers
{
    public class AccountController : NETMyProjectControllerBase
    {
